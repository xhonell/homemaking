package com.successTeam.appraise.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                 ...
                 */
                .apis(RequestHandlerSelectors.basePackage("com.successTeam.appraise.controller"))
                //过滤某个路径
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("评价微服务接口文档")
                .description("评价微服务接口文档")
                .contact(new Contact("admin", null, "admin@qq.com"))
                .version("1.0")
                .build();
    }
