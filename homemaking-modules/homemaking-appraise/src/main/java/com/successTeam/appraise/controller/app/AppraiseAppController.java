package com.successTeam.appraise.controller.app;
 ...
 */
@RestController
@RequestMapping("/app-api/appraise")
@Api(tags = "APP端评价相关接口")
public class AppraiseAppController {
    ...
    @ApiOperation("添加评价")
    public Result addAppraise(@RequestBody Appraise appraise){
    ...
    @ApiOperation("删除评价")
    public Result deleteAppraise(@RequestParam Long appraiseId){
        appraiseService.removeById(appraiseId);
        return Result.buildSuccess();
    }
