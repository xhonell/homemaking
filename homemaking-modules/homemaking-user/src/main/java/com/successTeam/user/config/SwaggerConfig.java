package com.successTeam.user.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                 ...
                 */
                .apis(RequestHandlerSelectors.basePackage("com.successTeam.user"))
                //过滤某个路径
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("天鹅到家用户微服务接口文档")
                .description("天鹅到家用户微服务接口文档")
                .contact(new Contact("zxd", null, "furong@qq.com"))
                .version("1.0")
                .build();
    }
